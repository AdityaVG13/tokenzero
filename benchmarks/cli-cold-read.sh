...
# Hyperfine is preferred, with /usr/bin/time fallback. Output is the established markdown table.
set -euo pipefail
...
log "binary: $BIN"; log "small file: $SMALL_FILE"; log "hyperfine: $(command -v hyperfine || echo fallback:/usr/bin/time)"
