...
jq -r '
  .telemetry as $t |
  [
    "ack",         ($t.ack_tokens // 0),; "ref_string",  ($t.ref_string_tokens // 0),
    "framing",     ($t.framing_tokens // 0),; "preview",     ($t.preview_tokens // 0),
    "payload",     ($t.payload_tokens // 0),; "envelope",    ($t.envelope_tokens // 0),
    "visible",     ($t.visible_tokens // 0),; "raw",         ($t.raw_tokens // 0)
  ] as $rows |
