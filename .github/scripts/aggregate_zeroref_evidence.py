...
def claim_evidence_map():
    return [
      {"claim_id":"cross_engine_blob_expand",
       ...
       "public_surfaces":["README.md","docs/core.md","docs/mcp.md","crates/tokenzero-mcp/src/catalog.rs"],
      ...
      {"claim_id":"byte_and_line_fragments",
       ...
       "public_surfaces":["docs/zeroref-v1-contract.md"],
      ...
      {"claim_id":"migration_and_rollback",
       ...
       "public_surfaces":["docs/zeroref-v1-contract.md",".github/workflows/ci.yml"],
