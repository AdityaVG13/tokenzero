...
impl CowSession {
    ...
    pub fn append(
        ...
        // Branch novelty is intentionally staged: checkpoint/discard commits the
        // payload and ledger in one recovery transaction, keeping fork cost
        // proportional to novelty instead of paying a full durable replay.
        Ok(recovery_ref)
    }
