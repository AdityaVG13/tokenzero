...
pub use packaging::{
    ...
    package_identity, reject_dual_env_selection, resolve_startup_surface, sbom_document,
    semantic_contract_digest, surface_compiled_in, uninstall_report, uninstall_surface,
    write_client_config,
};
